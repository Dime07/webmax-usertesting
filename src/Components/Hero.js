...
export default function Hero({headercolor, konten, dataDummy,url,bg}) {
    ...
    return(
        <div className="hero" >
            {bg === undefined && (
                <div className="hero-wrap w-full flex justify-between lg:flex-row  md:flex-col sm:flex-col" style={{backgroundColor : dataDummy.bgcolor}}>
                    ...
                    <div className="right-side lg:w-1/2 md:w-full text-right sm:w-full">
                        ...
                        {url !== undefined && (
                            <img className="mx-auto w-3/5 lg:inline md:hidden sm:hidden" src={url} alt="gambar hero"/>
                        )}
                    </div> 
                </div>
            )}
            {bg !== undefined && (
                <div className="hero-wrap w-full flex justify-between lg:flex-row  md:flex-col sm:flex-col" style={{backgroundImage : `url(${bg})`}}>
                <div className="left-side my-auto lg:py-0 md:py-5 sm:py-5 lg:w-1/2  md:w-full sm:w-full sm:text-center lg:text-left">
                    <p className="hero-title" style={{color : dataDummy.colorJudul}} >
                        {dataDummy.judul}
                    </p>
